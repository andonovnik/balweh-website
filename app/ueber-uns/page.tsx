    ...
    <main>
      <section className="mx-auto w-full max-w-6xl px-6 py-20 md:py-28">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-600">
          Balweh Service steht für professionelle Gebäudereinigung und hochwertigen Garten- & Landschaftsbau mit Sitz in Leverkusen. Von hier aus betreuen wir Privat- und Gewerbekunden in ganz Nordrhein-Westfalen. Unser Slogan ist dabei nicht nur ein Versprechen – sondern unsere tägliche Arbeitsweise: Qualität, die man sieht. Service, den man spürt.
        </p>
      ...
      <section className="mx-auto w-full max-w-6xl px-6 py-16">
        <article className="mb-8">
          ...
          <p className="mt-4 leading-8 text-zinc-600">
            Für uns beginnt Qualität bei der sorgfältigen Planung und endet erst
            mit einem Ergebnis, das langfristig überzeugt.
          </p>
          <p className="mt-4 leading-8 text-zinc-600">
        ...
        <article className="mb-8">
          ...
          <p className="mt-4 leading-8 text-zinc-600">
            Service bedeutet für uns mehr als nur die Ausführung eines Auftrags.
            Es bedeutet:
          </p>
          <ul className="mt-2 list-disc space-y-1 pl-6 leading-8 text-zinc-600">
        ...
        <article className="mb-8">
          ...
          <p className="mt-4 leading-8 text-zinc-600">
            ...
            aufgestellt und schnell einsatzbereit. Gleichzeitig realisieren wir
            Projekte im gesamten Nordrhein-Westfalen – flexibel, zuverlässig und
            professionell organisiert.
          </p>
          <p className="mt-4 leading-8 text-zinc-600">Wir betreuen unter anderem:</p>
          <ul className="mt-2 list-disc space-y-1 pl-6 leading-8 text-zinc-600">
            <li>Bürogebäude</li>
        ...
        <article>
          <h2 className="text-2xl font-semibold tracking-tight">Unser Anspruch</h2>
          <p className="mt-4 leading-8 text-zinc-600">
          ...
          <p className="mt-4 leading-8 text-zinc-600">
            Denn am Ende soll nicht nur das Ergebnis stimmen – sondern auch das
            Gefühl dabei.
          </p>
        </article>
      </section>
